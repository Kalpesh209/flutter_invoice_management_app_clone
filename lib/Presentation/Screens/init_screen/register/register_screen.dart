...
import 'package:flutter_invoice_management_app_clone/Presentation/Screens/init_screen/login/login_screen.dart';
  ...
  void showErrorScreen(BuildContext context, String message) {
    ...
    showDialog(
        ...
        builder: (BuildContext context) => AlertDialog(
              title: TextBuilderWidget(text: message),
              backgroundColor: AppColors.popupItemBackColor,
              shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(15)),
              actions: <Widget>[
                TextButton(
                  child: const TextBuilderWidget(text: "Ok"),
                  onPressed: () {
